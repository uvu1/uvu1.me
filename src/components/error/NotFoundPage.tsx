...
export function NotFoundPage() {
  return (
    <main className="grid min-h-[calc(100vh-12rem)] place-items-center px-6 py-16">
      <section className="relative w-full max-w-2xl overflow-hidden rounded-[2rem] border border-white/70 bg-[var(--card-bg)]/70 p-8 text-center shadow-[0_18px_60px_rgba(127,183,232,0.14)] backdrop-blur-xl">
        ...
        <div className="relative">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link
              to="/"
              className="inline-flex items-center gap-2 rounded-full border border-[var(--accent-strong)]/30 bg-[var(--card-bg)]/65 px-5 py-3 text-sm font-bold text-[var(--accent-strong)] transition hover:border-[var(--accent-strong)] hover:bg-[var(--blue-50)]/70"
            >
            ...
            <Link
              to="/articles"
              className="inline-flex items-center gap-2 rounded-full border border-[var(--accent-strong)]/20 bg-[var(--card-bg)]/45 px-5 py-3 text-sm font-bold text-[var(--text)] transition hover:border-[var(--accent-strong)]/45 hover:bg-[var(--card-bg)]/75 hover:text-[var(--accent-strong)]"
            >
