  ...
  return (
    <PageLayout maxWidth="lg">
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <section className="rounded-[2rem] bg-white/72 p-8 shadow-[0_16px_50px_rgba(127,183,232,0.12)] backdrop-blur-xl">
          <PinnedSection articles={pinnedArticles} />
          <ArchivesSection articles={archiveArticles} />
        </section>
        <aside className="rounded-[2rem] bg-white/62 p-8 shadow-[0_16px_50px_rgba(127,183,232,0.10)] backdrop-blur-xl">
          <ProfileCard />
          <TagsCard tags={tags} />
        </aside>
      </div>
